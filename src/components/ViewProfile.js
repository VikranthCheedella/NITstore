...
const ViewProfile = (props) => {
  ...
  return (
    <div className="container mt-5 d-flex justify-content-center">
      <div className="rounded-5 " style={{height:"27rem",width:"22rem",backgroundColor:"#46424f",display:"flex",flexDirection:"column",alignItems:"center", justifyContent:"space-evenly"}}>
      <button type="button" className="btn btn-primary d-none" data-bs-toggle="modal" data-bs-target="#exampleModal" ref={ref}>
        ...
        <div className="modal-dialog">
            <div className="modal-content" style={{backgroundColor:"#46424f"}}>
        ...
        <h3 style={{color:"#9171f8"}}>Your Details</h3>
        <div style={{width:"80%",height:"2px",backgroundColor:"#9171f8"}}></div>
