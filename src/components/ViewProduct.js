    ...
    <div className='container d-xl-flex justify-content-xl-around product'>
      <div className="viewproduct1 mt-4">
        ...
        <div className="viewproduct12 mt-4">
            <h4 className='ms-3 my-3' style={{color:"#9171f8"}}>Description</h4>
            <hr style={{color:"#9171f8"}}/>
            <p className='ms-3'>{viewproduct.description}</p>
        </div>
      </div>
      <div className='mt-4 viewproduct2'>
        <div className="viewproduct21">
            <h4 className='ms-3 my-3' style={{color:"#9171f8"}}>Product Details</h4>
            <hr style={{color:"#9171f8"}}/>
            <h5 className='ms-3'>{viewproduct.title}</h5>
            <p className='ms-3'><b>Price : </b> {viewproduct.price}/-</p>
        </div>
        <div className="viewproduct22 mt-4 ">
            <h4 className='ms-3 my-3' style={{color:"#9171f8"}}>Seller Details</h4>
            <hr style={{color:"#9171f8"}}/>
            <div className="d-flex justify-content-center"style={{width:"100%"}}>
                <img src={profile} alt="Image" className="rounded-circle mb-3 align-self-center"style={{height:"110px",width:"110px"}}/>
            </div>
            <p className='ms-3'><b>Name : </b>{seller.name}</p>
            <p className='ms-3'><b>Email : </b>{seller.email}</p>
            <p className='ms-3'><b>Phone no : </b>{seller.contact}</p>
        </div>
       </div>
    </div>
  )
