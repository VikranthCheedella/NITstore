...
const SellPackages = (props) => {
  ...
  return (
    ...
    <div className="rounded-4 " style={{height:"37rem",width:"23rem",backgroundColor:"#46424f",display:"flex",flexDirection:"column",alignItems:"center"}}>
      <h2 className='mt-5 mb-4' style={{color:"#9171f8"}}>Sell Your Products</h2>
