...
const Profilebox = (props) => {
  ...
  return (
    <div className="container mt-5 d-flex justify-content-center">
      <div className="rounded-5 " style={{height:"37rem",width:"22rem",backgroundColor:"#46424f",display:"flex",flexDirection:"column",alignItems:"center", justifyContent:"space-evenly"}}>
        <img src={profile} className="rounded-circle my-2"alt="Image" style={{height:"150px",width:"150px"}}/>
        <h3 style={{color:"#9171f8"}}>{user.name}</h3>
        <button className='btn' style={{width:"80%"}} onClick={viewprofile}>View and Edit Profile</button>
        <div style={{width:"80%",backgroundColor:"#9171f8",height:"1px"}}></div>
